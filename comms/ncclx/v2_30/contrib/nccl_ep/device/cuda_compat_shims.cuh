...
//
// Provides compatibility functions for features introduced in newer CUDA
// versions. These shims enable code written for CUDA 13+ to compile and run on
// CUDA 12.x by implementing missing functions using PTX assembly.
//
// Functions provided:
// - elect_sync: Warp leader election primitive (CUDA 13.0+)
// - cp_async_bulk overload: Async bulk copy shared→global (CUDA 13.0+)
//
// These shims automatically disable when the native implementations are
// available.
// ============================================================================
