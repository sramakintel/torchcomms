...
// Arbitrary version number - A given NCCL build will only be compatible with a
// single device networking plugin version. NCCL will check the supplied version
// number from net->getProperties() and compare to its internal version.
