...
typedef struct {
  ...
  double hwLatencies[NCCL_NUM_HW_LINKS][NCCL_NUM_ALGORITHMS]
                    [NCCL_NUM_PROTOCOLS];
...
typedef struct {
  ...
  //
  // InOut:
  //   - collCostTable: collective cost table, generated by NCCL core,
  //   containing algo|proto|time entries for collType.
  //                    NCCL core sets ignored algo/proto cost table entries to
  //                    -1.0 (NCCL_ALGO_PROTO_IGNORE).
  //
...
// V6 constants are the same as V5 - chunk size overrides are handled via
// callback
