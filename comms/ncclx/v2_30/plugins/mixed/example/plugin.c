...
__hidden ncclResult_t tunerPluginInit(
    void** context,
    uint64_t commId,
    size_t nRanks,
    size_t nNodes,
...
__hidden ncclResult_t tunerPluginGetCollInfo(
    void* context,
    ncclFunc_t collType,
    size_t nBytes,
    int numPipeOps,
  ...
  // Update NCCL core generated cost table. Updated table will be evaluated by
  // NCCL to pick the best algo/proto combo
...
__hidden ncclResult_t tunerPluginFinalize(void* context) {
  return ncclSuccess;
}
